...
public sealed class PerformancePlanBuilderTests
{
    ...
    {
        // Integrated GPU with no VRAM, 8 GB RAM, 4 CPU cores.
        ...
        // Conservative profile that never oversells weak hardware.
    ...
    {
        // Dedicated NVIDIA GPU with ample VRAM, RAM, and cores.
        var hardware = new HardwareSnapshot(
    ...
    {
        // Dedicated GPU but only 3 GB VRAM blocks the Performance tier.
        var hardware = new HardwareSnapshot(
    ...
    {
        // 4 GB machine where the reserve would otherwise zero the budget.
        var hardware = new HardwareSnapshot(
        ...
        // Never below the 2048 MB emulator minimum.
        plan.Tier.Should().Be("Entry");
