...
public sealed class CatalogTests
{
    ...
    {
        Nexora.Features.Graphics.Domain.PubgVersionCatalog.TryGetQualityValue(name, out var value).Should().BeTrue();
    ...
    {
        Nexora.Features.Graphics.Domain.PubgVersionCatalog.TryGetFrameRateValue(name, out var value).Should().BeTrue();
        value.Should().Be(expected);
    }
    ...
    {
        Nexora.Features.Graphics.Domain.PubgVersionCatalog.TryGetStyleValue(name, out var value).Should().BeTrue();
        value.Should().Be(expected);
    }
    ...
    {
        Nexora.Features.Graphics.Domain.PubgVersionCatalog.TryGetQualityValue("Nope", out _).Should().BeFalse();
        Nexora.Features.Graphics.Domain.PubgVersionCatalog.TryGetFrameRateValue("Nope", out _).Should().BeFalse();
        Nexora.Features.Graphics.Domain.PubgVersionCatalog.TryGetStyleValue("Nope", out _).Should().BeFalse();
    }
}
